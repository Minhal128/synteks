...
const stats = [
  { value: 186, suffix: "+", label: "Ship cycles delivered for clients", icon: Zap },
  { value: 30, suffix: "+", label: "Active & past clients worldwide", icon: Users },
  { value: 33, suffix: "%", label: "Average savings vs market rates", icon: TrendingUp },
];
      ...
      <section className="relative min-h-[70vh] flex flex-col items-center justify-center overflow-hidden pt-24 pb-12">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          >
            ...
            <span className="text-sm text-gray-300">How Synteks delivers</span>
          ...
          >
            ...
            <br />
            <span className="text-gradient-accent">Ship cleaner.</span>
          </motion.h1>
          ...
          >
            From discovery to deploy — senior engineers, clear scopes, and a delivery pulse you can
            actually trust. Premium quality at $20/hr.
          </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-6 relative">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              Real products Synteks has helped take to market
            </p>
          </div>
